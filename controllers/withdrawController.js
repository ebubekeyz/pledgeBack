...
export const getSingleWithdraw = async (req, res) => {
...
export const editSingleWithdraw = async (req, res) => {
  const { id: withdrawId } = req.params;
...
export const editUserWithdraw = async (req, res) => {
...
export const deleteSingleWithdraw = async (req, res) => {
  const { id: withdrawId } = req.params;
