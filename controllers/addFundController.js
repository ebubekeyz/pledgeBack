...
export const getAddFunds = async (req, res) => {
...
export const getSingleAddFund = async (req, res) => {
...
export const editSingleAddFund = async (req, res) => {
  const { id: addFundId } = req.params;
...
export const editUserAddFund = async (req, res) => {
...
export const deleteSingleAddFund = async (req, res) => {
  const { id: addFundId } = req.params;
...
export const deleteAllAddFunds = async (req, res) => {
  const addFund = await AddFund.deleteMany();
  res.status(StatusCodes.OK).json({ msg: 'AddFund Deleted' });
};

export const deleteUserAddFund = async (req, res) => {
  const { id: userId } = req.params;
